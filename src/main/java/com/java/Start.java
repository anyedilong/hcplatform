...
@NacosPropertySources({
        @NacosPropertySource(dataId = "hcplatform_dict", groupId = "DEFAULT_GROUP", autoRefreshed = true),
        @NacosPropertySource(dataId = "hcplatform_oracle", groupId = "DEFAULT_GROUP", autoRefreshed = true),
